...
import { Container, ContainerItems, ErrorMessage, Input, Label, RegisterImage, SignInLink } from './styles';
function Register() {
  ...
  return (
    <Container>
      ...
      <ContainerItems>
        ...
        <Button type="submit" style={{marginTop: 10, marginBottom: 10}}>Sign Up</Button>
        </form>
        <SignInLink> Já possui conta?{' '} 
        <Link style={{color: 'white'}} to= '/login'>Sign In</Link> </SignInLink>
      </ContainerItems>
    </Container>
  );
}
